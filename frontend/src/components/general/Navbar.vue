...
<template>
    <template v-if="checkUserRoleValid()">
        ...
        >
            ...
            <!-- Expand Button -->
            <button
                class="btn btn-light btn-lg rounded-5"
                type="button"
                data-bs-toggle="offcanvas"
                data-bs-target="#mainSideNavBar"
                aria-controls="mainSideNavBar"
            >
                <font-awesome-icon
                    class="fa-lg"
        ...
        <div
            ...
            tabindex="-1"
            id="mainSideNavBar"
            aria-labelledby="mainSideNavBarLabel"
        >
            <!-- Header (Top) -->
            <div class="offcanvas-header">
                ...
                <button
                    type="button"
                    class="btn btn-light ms-auto rounded-5"
            ...
            <div class="offcanvas-body d-flex flex-column">
                ...
                <div class="d-flex flex-column align-items-center mt-3">
                    <template v-for="e_nav_obj in navbarMap[userRole].main">
                        <button
                            class="btn w-100 mb-3 p-3 text-start"
                            :class="
                                isActiveRoute(e_nav_obj.route)
                                    ? 'btn-white-selected'
                                    : 'btn-light'
        ...
        <nav class="navbar navbar-expand-md bg-light d-md-none">
            <div class="container-fluid">
                ...
                <button
                    ...
                    data-bs-target="#topNavbarMain"
                    aria-controls="topNavbarMain"
                    aria-expanded="false"
                ...
                <div class="collapse navbar-collapse p-3" id="topNavbarMain">
                    ...
                    <div class="container-fluid p-0">
                        <div class="row m-0">
                            <template
                                v-for="e_nav_obj in navbarMap[userRole].main"
                            >
                    ...
                    <div class="container-fluid p-0">
                        <div class="row m-0">
                            <template
                                v-for="e_nav_obj in navbarMap[userRole].hidden"
                            >
                                <div class="col-auto p-0 me-3">
                                    <button
                                        class="btn w-100 p-3 text-start"
...
export default {
    ...
    mounted() {
        ...
        this.sideBarElem = new bootstrap.Offcanvas(
            document.getElementById("mainSideNavBar")
        );
        this.topNavBarElem = new bootstrap.Collapse(
            document.getElementById("topNavbarMain"),
            {
                toggle: false,
            }
        );
