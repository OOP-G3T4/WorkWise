    ...
    <div class="container-fluid p-0 m-0">
        <div class="row justify-content-between align-items-center m-0">
            ...
            <div class="col-auto p-0">
                <button v-for="(e_range, idx) in Object.keys(timeRanges)" class="btn btn-resp" :class="timeRangeClasses(e_range, idx)" @click="handleTimeRangeClick(e_range)">
                    {{ e_range }}
                </button>
            </div>
            ...
            <div class="col-auto p-0 d-flex">
                <button class="btn btn-resp btn-light" @click="shiftToday()"><font-awesome-icon icon="fa-solid fa-calendar" /><span class="d-none d-sm-inline ms-2 text-secondary">Skip to Today</span></button>
            </div>
