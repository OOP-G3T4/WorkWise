    ...
    <div class="container-fluid bg-white py-4">
        <div class="row justify-content-between">
            <div class="col-auto p-0 d-flex">
                <button v-for="e_status in possibleFilters" class="btn me-2" :class="statusBtnClass(e_status)" @click="toggleStatus(e_status)" data-bs-toggle="button">{{ e_status }}</button>
            </div>
